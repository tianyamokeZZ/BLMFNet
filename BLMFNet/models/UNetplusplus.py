...
class UnetPlusPlus(nn.Module):
    ...
    def forward(self, x):
        ...
        # F.interpolate(self.upsample_2_1(x_3_0), x_2_0.size()[2:], mode='bilinear')
        # x_2_1 = torch.cat([self.upsample_2_1(x_3_0), x_2_0], 1)
        x_2_1 = torch.cat([F.interpolate(self.upsample_2_1(x_3_0), x_2_0.size()[2:], mode='bilinear'), x_2_0], 1)
        ...
        x_2_2 = torch.cat([F.interpolate(self.upsample_2_1(x_3_1), x_2_0.size()[2:], mode='bilinear'), x_2_0, x_2_1], 1)
...
#     inputs = torch.randn((2, 3, 512, 512)).to()
#     model = UnetPlusPlus(num_classes=1, deep_supervision=False).to()
...
if __name__ == '__main__':
    model = UnetPlusPlus(num_classes=1, deep_supervision=False).to("cuda")
    # model.train()
