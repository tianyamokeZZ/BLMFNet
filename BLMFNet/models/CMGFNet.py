...
class FuseNet(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        self.resnet_features = models.resnet34()
        ...
        # DSM Encoder Part
        self.encoder_depth = models.resnet34()
...
#     sar = torch.randn(1, 1, 512, 512)
#     print(model)
#     output = model(opt, sar)
...
if __name__ == '__main__':
    model = FuseNet(num_classes=1).to("cuda")
    # model.train()
    # opt = torch.randn(1, 3, 512, 512)
    # output = model(opt)
    ...
    input1 = torch.randn(1, 1, 512, 512).to("cuda")
