...
from models.model.deeplab_resnet import ModelBuilder
...
class GCN(nn.Module):
    def __init__(self, num_classes, kernel_size=7):
        ...
        self.gcm1 = _GlobalConvModule(2048, num_classes, kernel_size=(kernel_size, kernel_size))
        self.gcm2 = _GlobalConvModule(1024, num_classes, kernel_size=(kernel_size, kernel_size))
        self.gcm3 = _GlobalConvModule(512, num_classes, kernel_size=(kernel_size, kernel_size))
        self.gcm4 = _GlobalConvModule(256, num_classes, kernel_size=(kernel_size, kernel_size))
...
#     model = GCN(num_classes=1, kernel_size=7).cuda()
#     model.freeze_bn()
#     model.eval()
...
if __name__ == '__main__':
    model = GCN(num_classes=1, kernel_size=7).to("cuda")
    # model.train()
