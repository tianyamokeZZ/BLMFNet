...
class HRNetBackbone(object):
    ...
    def __call__(self):
        arch_net = HighResolutionNet(self.hrnet48_config, bn_type='inplace_abn', bn_momentum=0.1)
        return arch_net
...
if __name__ == "__main__":
    ...
    print(arch_net)
    output = arch_net(opt)
    # print("output:",output.shape) # 返回4个tensor 1 48 128 128 1 96 64 64 1 192 32 32 1 384 16 16