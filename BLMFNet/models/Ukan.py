...
class UKAN(nn.Module):
    def __init__(self, num_classes, input_channels=3, img_size=224,
                 embed_dims=[256, 320, 512], num_heads=[1, 2, 4, 8], qkv_bias=False,
    ...
    def forward(self, x):
        ...
        out = F.relu(F.interpolate(self.decoder3(out), size=(t2.size()[2], t2.size()[3]), mode='bilinear'))
...
if __name__ == '__main__':
    model = UKAN(input_channels=3, num_classes=1, img_size=512).to("cuda")
    # model.train()
