...
class DFCtrack2Datasettest(Dataset):
    def __init__(self, root, sync_transforms=transform):
        ...
        mask_dir = os.path.join(root, 'test_dataset')
        img_boundary_dir = os.path.join(root, 'boundary_building')
...
if __name__ ==  "__main__":
    isbi_dataset = DFCtrack2Datasettest(root="/home/omnisky/ZZ/DFCtrack2/DFCtrack2_for_experiment")  # 数据
